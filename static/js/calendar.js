...
window._dynarch_popupCalendar = null;
Calendar._DN = new Array("Domingo", "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira", "Sábado", "Domingo");
...
Calendar._TT.ABOUT = "DHTML Date/Time Selector\n(c) dynarch.com 2002-2005 / Author: Mihai Bazon\nFor latest version visit: http://www.dynarch.com/projects/calendar/\nDistributed under GNU LGPL.  See http://gnu.org/licenses/lgpl.html for details.\n\nSeleção de data:\n- Use os \xab, \xbb botões para selecionar o ano\n- Use os " + String.fromCharCode(8249) + ", " + String.fromCharCode(8250) + " botões para selecionar o Mês\n- Segure o botão do mouse sobre qualquer um dos botões acima para uma selecção mais rápida.";
Calendar._TT.ABOUT_TIME = "\n\nTime selection:\n- Clique em qualquer das partes tempo para aumentá-lo\n- ou Shift + clique para diminuir  it\n- ou clique e arraste para a seleção mais rápido.";
...
/* http://keith-wood.name/timeEntry.htm
